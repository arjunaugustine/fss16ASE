...
The=o(cohen=0.3, small=3, epsilon=0.01,
      width=50,lo=0,hi=100,conf=0.01,b=1000,a12=0.56, text=12)
...
def _ab12():
    ...
    for tag, one,two in [("1less",l1,more),("1more",more,less),("same",l1,l2)]:
...
def _bootstraped(): 
    def worker(n=1000,
        ...
        return n,mu1,sigma1,mu2,sigma2,'different' if bootstrap(x,y) else 'same'
